...
public interface SqlServerJdbcConfiguration extends JdbcConfiguration {
    ...
    public static final Field INSTANCE =
            Field.create("instance", "Named instance of the database server");
     ...
     */
    public static interface Builder extends ConfigBuilder<SqlServerJdbcConfiguration, Builder> {
        /**
    ...
    /**
     * Create a new {@link Builder configuration builder} that starts with a copy of the supplied
     * configuration.
     *
