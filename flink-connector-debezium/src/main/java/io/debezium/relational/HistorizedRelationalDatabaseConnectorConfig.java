...
public abstract class HistorizedRelationalDatabaseConnectorConfig extends RelationalDatabaseConnectorConfig {
	...
	public DatabaseHistory getDatabaseHistory() {
		...
		DatabaseHistoryListener listener = config.getBoolean(JMX_METRICS_ENABLED)
		...
		databaseHistory.configure(dbHistoryConfig, historyComparator, listener, useCatalogBeforeSchema); // validates
